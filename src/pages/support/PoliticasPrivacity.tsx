        ...
        <section className="bg-white text-gray-800 px-6 py-10 max-w-5xl mx-auto font-fam-ge">
            ...
            <div className="space-y-6 text-justify text-md leading-relaxed font-fam-two">
                ...
                <p className="text-base">
                    ...
                    de Perú. Nos aseguramos de que cumplan estándares internacionales
                    de privacidad antes de transferir datos.
                </p>
                ...
                <h2 className="font-bold text-xl">¿Cambios en esta Política de Privacidad?</h2>
                <p className="text-base">
